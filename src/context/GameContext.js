...
const gameReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case 'REVEAL_CARD':
      ...
      blueRem = cards.filter(({ color, revealed }) => color === 'blue' && !revealed).length;
      redRem = cards.filter(({ color, revealed }) => color === 'red' && !revealed).length;
    ...
    case 'TOGGLE_REVEALED_WORDS':
      ...
      return { 
        ...state,
        showRevealed: action.showRevealed
       };
